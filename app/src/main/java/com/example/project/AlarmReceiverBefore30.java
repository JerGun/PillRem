...
public class AlarmReceiverBefore30 extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String mTitle = "อีก 30 นาที ต้องกินยา " + alarm.getTitle();
    ...
    public void setAlarm(Context context, Calendar calendar, int ID) {
        ...
        Intent intent = new Intent(context, AlarmReceiverBefore30.class);
        ...
        long diffTime = calendar.getTimeInMillis() - currentTime - 1800000L;
    ...
    public void setRepeatAlarm(Context context, Calendar calendar, int ID, long RepeatTime) {
        ...
        mAlarmManager.setRepeating(AlarmManager.ELAPSED_REALTIME,
                SystemClock.elapsedRealtime() + diffTime - 1800000L,
    ...
    public void cancelAlarm(Context context, int ID) {
        ...
        mPendingIntent = PendingIntent.getBroadcast(context, ID, new Intent(context, AlarmReceiverBefore30.class), 0);
