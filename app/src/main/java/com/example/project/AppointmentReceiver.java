...
public class AppointmentReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String mTitle = "ถึงเวลานัด " + appointment.getTitle() + " ที่ " + appointment.getLocation();
    ...
    public void cancelAlarm(Context context, int ID) {
        ...
        mPendingIntent = PendingIntent.getBroadcast(context, ID, new Intent(context, AppointmentReceiver.class), 0);
